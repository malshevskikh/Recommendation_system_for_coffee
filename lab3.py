...
def second_variant(coffe_set, countries, tree, ar):
  main_arr = []
  n = True
  while (n == True):
    ...
    print("------------------------------------------------------------------------------------------------------------------")
    print("Заново выбрать лайки и посмотреть рекомендацию - 1")
    print("Заново выбрать новый пункт - 2")
    print("Закончить - 3")
    # print(u, type(u))
    b = False
    while (b == False):
...
def third_variant(coffe_set, countries, tree, ar):
  main_arr = []
  n = True
  while (n == True):

    #print("Тут массив с лайками и дизлайками")
    likes_and_dislikes = choose_list_of_coffee(coffe_set, ar)
